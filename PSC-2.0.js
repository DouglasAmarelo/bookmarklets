...
(function() {
	...
	var authorsList  = [ 'douglas', 'ursula.marinho', 'carol.barrios', 'stephani.galvani', 'marcelo.pavone' ];
...
// Bookmarklet
javascript:void%20function(){(function(){function%20e(){var%20e=document.querySelectorAll(%22.action-details%20a%22);-1==a.indexOf(r)%26%26a.push(r);for(var%20o=0,u=e.length;u%3Eo;o++){var%20l=e[o].getAttribute(%22rel%22);-1==a.indexOf(l)%26%26l!==n%26%26a.push(l)}t()}function%20t(){for(var%20e=0;e%3Ca.length;e++){var%20t=a[e];c+=%22%20[~%22+t+%22]%20%22}}var%20r=document.querySelector(%22%23reporter-val%20span%22).getAttribute(%22rel%22),n=document.querySelector(%22%23assignee-val%20span%22).getAttribute(%22rel%22),o=document.querySelector(%22.collapsed-comments%22),a=[%22douglas%22,%22ursula.marinho%22,%22carol.barrios%22,%22stephani.galvani%22,%22marcelo.pavone%22],u=document.querySelector(%22%23comment%22),l=u.value,c=%22%22;o%26%26o.click(),setTimeout(function(){e(),u.value=l+%22\n%22+c+%22%20PSC%22},2500)})()}();
